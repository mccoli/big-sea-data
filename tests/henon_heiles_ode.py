...
#
  ...
  plt.legend ( ( 'X', 'X\'', 'Y', 'Y\'' ) )
  plt.savefig ( 'C:\\Users\\mccal\\Documents\\CCI\\big-data\\big-sea-data\\img\\euler.png' )
  print ( 'Graphics saved as euler.png' )
  ...
  plt.savefig ( 'C:\\Users\\mccal\\Documents\\CCI\\big-data\\big-sea-data\\img\\orbit.png' )
  print ( 'Graphics saved as orbit.png' )
  plt.show ( block = False )
  plt.close ( )
